...
description: "You''ll need to download and install raspberry pi imager from the official website."
---

### Provisioning your pi
You'll need to download and install raspberry pi imager from the [official website](https://www.raspberrypi.org/software/). After you've done that, open it.
...
Now, you'll need to install k3s. First become root by running `sudo su -`, then install k3s by running `curl -sfL https://get.k3s.io | sh -`. After that's done, check for nodes, by running `kubectl get node`.
...
Now, why not [buy me a coffee](https://www.buymeacoffee.com/jem), or follow me on [twitter](https://twitter.com/jhqcat) or [github](https://github.com/jacobhq). Have a great day. :)
